/**
 * XSMB REST API — Pairs & Reverse Numbers Statistics Endpoint
 * GET /api/v1/xsmb/statistics/pairs?range=30days
 */
...
export async function GET(request: NextRequest) {
  try {
    ...
    const data = await statisticsDeepService.getPairAnalysis(range);
